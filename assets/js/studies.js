            ...
            <div v-for="estudios in estudiosFormalesList">
                <a :href= "estudios[3].link" target="_blank">
                    <ul>
                        ...
                        <li class="p-titulo">{{ estudios[1].titulo }}<img class="link" src="assets/svg/link.svg" alt="icono-link" width="10" height="15"></li>
            ...
            <div v-for="curso in cursosList">
                <a :href= "curso[3].link" target="_blank" >
                    <ul>
                        ...
                        <li class="p-titulo">{{ curso[1].tipo }}<img class="link" src="assets/svg/link.svg" alt="icono-link" width="10" height="15"></li>
